...
//		var oBtn = document.getElementById('btn_search');
		var oBtn = document.getElementsByClassName('search-img')[0];
...
//				console.log(data);
	...
	render: function(){
		var goodsListArr = [];
		console.log(this.state.goodsListResult);
...
//		console.log(this.props.name);
		var _imgs = JSON.parse(this.props.name.imgsUrl);
			...
			<div>
				<div className="type-list">
					<div className="type-list-title">
						全部<img src="img/25.png" className="type-list-title-img" />
					</div>
					{typeItemArr}
				</div>
			</div>
		...
		return (
			<div>
				<div className="type-list-item">
					{this.props.name.className}<img src="img/23.png" className="type-list-item-img" />
				</div>
			</div>
		)
	}
...
/* *********MoreComponent begin ********* */
var  MoreComponent = React.createClass({
	mixins:[Tool],
	render : function(){
		return (
			<div className="more-box">
				<ul className="more-ul">
					<li className="more-item">
						<a href="" className="more-item-font">常见问题</a>
						<img src="img/23.png" alt="" className="more-item-img" />
					</li>
					<li className="more-item">
						<a href="" className="more-item-font">系统设置</a>
						<img src="img/23.png" alt="" className="more-item-img" />
					</li>
					<li className="more-item">
						<a href="" className="more-item-font">软件更新</a>
						<img src="img/23.png" alt="" className="more-item-img" />
					</li>
					<li className="more-item">
						<a href="" className="more-item-font">扫描二维码</a>
						<img src="img/23.png" alt="" className="more-item-img" />
					</li>
					<li className="more-item">
						<a href="" className="more-item-font">我要提意见</a>
						<img src="img/23.png" alt="" className="more-item-img" />
					</li>
					<li className="more-item more-noborder" >
						<a href="" className="more-item-font">关于</a>
						<img src="img/23.png" alt="" className="more-item-img" />
					</li>
				</ul>
				<div className="btn_loginout">
	...
	componentDidMount : function(){
		var _this = this;
		$('.more-box').on('click','.btn_loginout',function(){
			var isOk = confirm('确定要退出吗？')
			if(isOk){
				var _node = document.getElementById('shopCarTemp');
				var _back = document.getElementsByClassName('back')[0];
				var _tool = document.getElementsByClassName('tool')[0];
...
//		console.log(evt.target);
		...
		var _node = document.getElementById('shopCarTemp');
		var _back = document.getElementsByClassName('back')[0];
		var _font = document.getElementsByClassName('font')[0];
		var _tool = document.getElementsByClassName('tool')[0];
		var _username = localStorage.getItem('userName');
		_back.innerHTML='';
		_tool.innerHTML='';
...
//						ReactDOM.render(<img src="img/header-shopcar.png"/>,_font);
						if(len>0){
							ReactDOM.render(<ShopCarComponent/>,_node);
						}else{
							ReactDOM.render(<EmptyCarCmponent/>,_node);
						}
					}
				});
			}
			...
			ReactDOM.render(<TypeHeaderComponent/>,_back);
			$('.font').eq(0).html('更多');
			ReactDOM.render(<MoreComponent/>,_node);
			break;
			default:
			break;
		}
...
ReactDOM.render(<LayoutComponent/>,document.body); // LayoutComponent ShopCarComponent LoginComponent
